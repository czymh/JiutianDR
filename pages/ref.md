...
If you use data from the Jiutian simulations, please include

- a citation to the overview paper
- citations to corresponding module or data product papers
- the following acknowledgement: 
  >The Jiutian simulations were supported by China Manned Space Project No. CMS-CSST-2021-A03.
...
- Emulator runs
  ...
  * [III: hybrid Lagrangian bias expansion](https://ui.adsabs.harvard.edu/abs/2025arXiv250604671Z/abstract)
